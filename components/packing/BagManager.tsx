...
import { Plus, Luggage, Edit2, Trash2, X, Package, Star, ArrowLeft, Suitcase, Camera, CheckCircle, Briefcase, TrendingUp, Calendar, MapPin, ArrowRight, Zap, ChevronDown, ChevronUp, Lightbulb, Target } from 'lucide-react';
